...
# CONFIGURATION
# ==============================================================================
TRAIN_DATA_PATH = 'data/class5assignment/train_clean.csv'
MODEL_BUNDLE_PATH = 'output/c5a_clean_model_bundle.joblib'
...
def plot_training_history(history):
    ...
    plt.savefig('output/c5a_clean_training_history.png')
    plt.show()
